...
## 3. Final Logistic Regression on Full Data (200k)
### 3.1 Load & Prepare Full Data
### 3.2 Train/Test Split & Recipe
### 3.3 Last Fit, ROC & Confusion Matrix
### 3.4 VIP / Coefficients & Interpretation
```{r}
data_recipe <- 
